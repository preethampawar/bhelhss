<div  class='content'>	
	...
	<p><?php echo $this->Html->Link('+ Add New Post', '/admin/posts/add/'.$categoryInfo['Category']['id']);?></p>
	<div class='clear'></div>
	<?php
	if(!empty($posts)) {
	?>
		<table class='table'>
			<thead>
				<tr>
					...
					<th>Post Name</th>								
					<th style="width:120px;">Photo Sharing</th>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:center;"><?php echo ($postPhotoSharing) ? "<span title='$postName'>Yes</span>" : "<span title='$postName'>No</span>"; ?></td>
