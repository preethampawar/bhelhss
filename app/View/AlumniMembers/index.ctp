...
if ($download) {
	...
	if ($alumniMembers) {
		...
		foreach ($alumniMembers as $alumniMember) {
			...
			$tmp[] = $paymentConfirmed ? 'Confirmed' : 'Not Confirmed';
			$tmp[] = $amountPaid ? ((float)$amountPaid) : '';
	...
	<div class="container">
		...
		<div class="mb-4">
			...
			<div class="row text-center">
				...
				<div class="col-12 col-md-3">
					<?php
					echo $this->Form->create(null, ['url' => '/AlumniMembers/?searchby=registered-today']);
					?>
				...
				<div class="col-12 col-md-3">
					<form method="get">
						...
						<button type="submit" class=" btn btn-info text-center p-4 rounded-pill w-100 fs-4 d-block">
							Payments Confirmed
							<br>
							<span class="badge alert-light text-info rounded-pill fs-3 mt-3"><?php echo $paymentsConfirmedCount; ?></span>
						</button>
					</form>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12 mb-3 px-4">
				<div class="navbar-buttons mbr-section-btn text-end">
					...
					<a href="/AlumniMembers/index/1?<?php echo $params; ?>" class="btn btn-outline-secondary display-4 m-0 mt-1 py-3">Download</a>
				</div>
			</div>
		</div>
					...
					<div class="table-responsive">
						<table class="table table-hover small mt-0">
							...
							<tr>
								...
								<th>Phone</th>
								<th>Email</th>
								<th class="text-center">Accounts Verified</th>
								<th class="text-center">Payments Confirmed</th>
								<th>Amount</th>
								<th>Registered On</th>
								<th>Actions</th>
							</tr>
							...
							foreach ($alumniMembers as $alumniMember) {
								...
								<tr>
									...
									<td class="text-center" title="Payment Confirmed?"><?php echo $paymentConfirmed ? '<span class="text-success">Yes</span>' : '<span class="text-danger">No</span>'; ?></td>
									...
									<td>
										...
										<a href="/hss/member_payment/<?php echo $alumniMemberId; ?>" class="ms-2">Payments</a>
