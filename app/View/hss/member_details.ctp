				...
				<form method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
					...
					<div class="row mt-4">
						<div class="col-sm-12 form-group mb-3" data-for="name">
							<input type="text" name="data[User][name]" placeholder="Name" data-form-field="name" class="form-control" value="<?php echo $name; ?>" id="name-register-form" required disabled>
						</div>
						<div class="col-sm-12 form-group mb-3" data-for="email">
							<input type="email" name="data[User][email]" placeholder="Email" data-form-field="email" class="form-control" value="<?php echo $email; ?>" id="email-register-form" required disabled>
						</div>
					</div>
					<div class="row">
						<div class="col-md col-12 form-group mb-3" data-for="number">
							<input type="text" name="data[User][phone]" placeholder="Phone" data-form-field="url" class="form-control" value="<?php echo $phone; ?>" id="phone-register-form" required disabled>
						</div>
					...
					<div class="row mt-3">
						<div class="col-md col-sm-12 form-group mb-3 px-4 fs-4" data-for="number">
							<div class="form-check form-switch">
								...
								<input name="data[User][account_verified]" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" value="1" <?php echo $accountVerified == 1 ? 'checked' : ''; ?>  disabled>
					...
					<div class="row mt-4">
						<div class="col-lg-12 col-md-12 col-sm-12 align-center mbr-section-btn">
							...
							<a href="/hss/alumni_members" class="btn btn-primary">Back</a>
							<a href="/hss/edit_member/<?php echo $id; ?>" class="btn btn-outline-secondary ms-3">Edit Account</a>
							<a href="/hss/member_payment/<?php echo $id; ?>" class="btn btn-outline-secondary ms-3">Manage Payments</a>
						</div>
					</div>
				</form>
			</div>
