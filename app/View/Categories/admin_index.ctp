...
<div id='adminCategoryNavigation' style="width:400px;">
		...
		?>
				...
				<?php echo $k.'. '.$this->Html->link($categoryDisplayName, '/admin/posts/showPosts/'.$categoryID.'/'.$categoryNameSlug, array('title'=>$categoryName, 'style'=>'width:350px; overflow:hidden;', 'escape'=>false));?>					
